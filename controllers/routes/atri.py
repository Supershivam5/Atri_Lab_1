...
class Atri:
	...
	@property
	def Toggle2(self):
		self._getter_access_tracker["Toggle2"] = {}
		return self._Toggle2
	@Toggle2.setter
	def Toggle2(self, new_state):
		self._setter_access_tracker["Toggle2"] = {}
		global default_state
		self._Toggle2 = Toggle(new_state, default_state["Toggle2"])
...
class TogglecustomClass:
	def __init__(self, state, def_state):
		...
		self.activeColor: str = get_defined_value(state, def_state, "activeColor")
		self.active: bool = get_defined_value(state, def_state, "active")
		self.inactiveColor: str = get_defined_value(state, def_state, "inactiveColor")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
...
class Toggle:
	def __init__(self, state, def_state):
		...
		self._def_state = def_state
		self.onChange = False
		self.styles: TogglestylesClass = get_defined_value(state, def_state, "styles")
		self.custom: TogglecustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = TogglestylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = TogglecustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
